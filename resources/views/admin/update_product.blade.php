            ...
            <div class="content-wrapper">
              ...
              <form action="{{url('/update_product_confirm',$product->id)}}" method="POST" enctype="multipart/form-data">
               ...
               @csrf
                ...
                placeholder="write a title" required="" value="
                {{$product->title}}">
                </div>
                ...
                <div class="div_design">
                  ...
                  placeholder="write a description" required="" value="
                  {{$product->description}}">
                  </div>
                    ...
                    <div class="div_design">
                      ...
                      placeholder="write a price" required="" value="
                      {{$product->price}}">
                      </div>
                      ...
                      <div class="div_design">
                        ...
                        placeholder="write a Discount is apply" value="
                      ...
                      <div class="div_design">
                        ...
                        placeholder="write a quantity" required="" value="
                        {{$product->quantity}}">
                        </div>
